      ...
      <section className="w-full max-w-[1440px] px-5 md:px-10 py-5 mx-auto relative z-10">
        ...
        <section className="font-medium text-cyan-950 flex lg:flex-row flex-col items-center gap-8">
          <div className="w-full">
            ...
            <button className="flex gap-2 items-center font-roboto p-5 ring-2 ring-cyan-900 hover:ring-cyan-500 hover:bg-cyan-900 hover:text-orange-50 rounded-xl ring-inset bg-orange-50 mb-8">
